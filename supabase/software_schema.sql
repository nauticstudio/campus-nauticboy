-- =============================================
-- NAUTIC CAMPUS - SOFTWARE LIBRARY SCHEMA
-- =============================================
...
-- 2. CATEGORIES (Synth, FX, Sampler, Utility, etc.)
...
-- 3. TAGS (Techno, House, VST3, Windows, etc.)
...
-- 4. SOFTWARE PRODUCTS (Plugins, Synthesizers, FX Units)
...
-- 5. SOFTWARE ITEMS (Installers, Factory Content, Expansions, Presets, Skins)
