          ...
          {filteredGroups.map(group => {
            ...
            return (
              ...
              >
                ...
                {/* Bottom Row: Clean Download Buttons without Version inside */}
                  ...
                  {hasBoth ? (
                    <div className="grid grid-cols-2 gap-2.5 w-full">
                      ...
                      <a
                        ...
                        className="inline-flex items-center justify-center gap-2 py-2.5 px-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-white font-bold text-xs border border-white/20 transition-all active:scale-95 group/mac shadow-sm text-center cursor-pointer"
                      ...
                      <a
                        ...
                        className="inline-flex items-center justify-center gap-2 py-2.5 px-2.5 rounded-xl bg-[#0078D4]/10 hover:bg-[#0078D4]/25 text-sky-200 font-bold text-xs border border-[#0078D4]/40 transition-all active:scale-95 group/win shadow-[0_0_12px_rgba(0,120,212,0.15)] text-center cursor-pointer"
                      ...
                      >
                        ...
                        <span>Windows</span>
                        {winItem!.file_size && (
                          <span className="text-[10px] text-sky-300/80 font-mono font-normal">
                    ...
                    <a
                      href={`/api/download/${macItem.id}`}
                      download={macItem.file_name}
                      className="inline-flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-white/10 hover:bg-white/15 text-white font-bold text-xs border border-white/20 transition-all active:scale-95 shadow-sm w-full group/mac cursor-pointer"
                      title={`Descargar macOS (${formatFileSize(macItem.file_size)})`}
                    >
                      <AppleLogo className="w-4 h-4 text-white shrink-0" />
                      <span>Descargar para macOS</span>
                      {macItem.file_size && (
                        <span className="text-[11px] font-mono text-ink-300 font-normal ml-1">
                          ({formatFileSize(macItem.file_size)})
                        </span>
                      )}
                    </a>
                    ...
                    <a
                      href={`/api/download/${winItem.id}`}
                      download={winItem.file_name}
                      className="inline-flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-[#0078D4]/15 hover:bg-[#0078D4]/30 text-sky-200 font-bold text-xs border border-[#0078D4]/40 transition-all active:scale-95 shadow-[0_0_15px_rgba(0,120,212,0.2)] w-full group/win cursor-pointer"
                      title={`Descargar Windows (${formatFileSize(winItem.file_size)})`}
                    >
                      <span className="inline-flex items-center justify-center bg-[#0078D4]/25 text-sky-200 p-0.5 rounded border border-[#0078D4]/40 shrink-0">
                        <WindowsLogo className="w-3.5 h-3.5 text-sky-300" />
                      </span>
                      <span className="font-bold text-xs text-sky-100">Descargar para Windows</span>
                      {winItem.file_size && (
                        <span className="text-[11px] font-mono text-sky-300 font-normal ml-1">
                          ({formatFileSize(winItem.file_size)})
                        </span>
                      )}
                    </a>
