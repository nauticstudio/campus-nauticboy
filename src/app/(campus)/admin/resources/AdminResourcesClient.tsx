...
import { Upload, Shield, FileText, CheckCircle2, Lock, HardDrive, Eye, EyeOff, Package } from 'lucide-react'
    ...
    <div className="p-6 md:p-10 lg:p-12 space-y-8 max-w-7xl mx-auto">
      ...
      <div className="glass-card rounded-3xl overflow-hidden shadow-sm">
        <div className="p-5 border-b border-slate-100 flex items-center justify-between">
          <h2 className="text-lg font-extrabold text-slate-900">Recursos Registrados en Supabase</h2>
        ...
        {resources.length === 0 ? (
          <div className="p-12 text-center space-y-4">
            ...
            <h3 className="text-lg font-extrabold text-slate-900">No hay recursos subidos</h3>
            <p className="text-xs font-semibold text-slate-500 max-w-sm mx-auto">
              Aún no has subido ningún archivo a Google Drive / Supabase. Al subir archivos reales se listarán en esta tabla.
            </p>
          </div>
        ) : (
              ...
              <div key={res.id} className="p-5 flex items-center justify-between gap-4 hover:bg-slate-50/60 transition-colors">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-xs font-medium text-slate-400 font-mono">{res.file_name}</span>
                  </div>
                </div>
